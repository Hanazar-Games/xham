export type AnimeSeriesId = 'demon-slayer' | 'one-piece' | 'naruto' | 'ghibli' | 'rezero' | 'frieren' | 'crossover' | 'attack-on-titan' | 'death-note' | 'fullmetal-alchemist-brotherhood' | 'one-punch-man'
